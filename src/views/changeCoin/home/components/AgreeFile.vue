<template>
  <div class="agreeFixed" v-if="show">
    ...
    <div class="agreeContentW">
      <h1>
        椰子分兑换{{userinfo.coinAlisa ? userinfo.coinAlisa : '金币'}}说明
      </h1>
      <div class="agreeContent">
        ...
        <h2>三、兑换游戏{{userinfo.coinAlisa ? userinfo.coinAlisa : '金币'}}流程：</h2>
        ①绑定椰子分账号</br>
        ②实名认证（月累计兑换金额超3万椰子分时）</br>
        ③输入充值{{userinfo.coinAlisa ? userinfo.coinAlisa : '金币'}}的游戏账号，兑换{{userinfo.coinAlisa ? userinfo.coinAlisa : '金币'}}（支付费用包含{{userinfo.coinAlisa ? userinfo.coinAlisa : '金币'}}等值的椰子分、服务费及税费，在兑换记录可查看明细及充值的游戏账号）</br>
        <table>
          <tr>
            <td>服务费</td>
            <td>2%</td>
